...
1. **否定前置**：不写"不是/不对/不像/没有X——Y"，直接写正面。
2. **不解释动作**：写完动作立即接后果或下一动作，中间不夹"这意味着""他在……"。
3. **不分析话语**：角色说完话就完。不跟在后面分析情绪成分。
4. **笑就是笑**：不附加"短促的""比昨天更轻"等物理测量。
5. **角色不知道下一秒**：不确定的事用推断语气，不是全知断言。

**每段写完后自查**：刚写的段落里有没有破折号后紧跟解释？有没有动作后跟了句含义说明？有就删。
